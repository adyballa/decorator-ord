...
import { IOrd, TDirection, IOrdFieldProperty, IOrdField, IOrdConfig } from "./ord.interface";
export declare class Field extends EqField implements IOrdField {
    name: string;
    dir: TDirection;
    map: Array<string>;
    constructor(name: string, props: IOrdFieldProperty);
...
export declare class OrdConfig extends EqConfig implements IOrdConfig {
    ...
    static setOrdinalityOfField(name: string, fields: Array<IField>, newIndex?: number): void;
}
